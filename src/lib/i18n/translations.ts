...
const translations: Record<Locale, Record<TranslationKey, string>> = {
  "pt-BR": {
    ...
    "privacy.intro": "O Ponto do Saber leva sua privacidade a sério. Esta política descreve como coletamos, usamos e protegemos suas informações pessoais em conformidade com a Lei Geral de Proteção de Dados Pessoais (LGPD - Lei nº 13.709/2018).",
    "privacy.consent": "Ao criar uma conta na plataforma Ponto do Saber, você declara ter lido e concordado com esta Política de Privacidade.",
    "terms.title": "Termos de Uso",
    "terms.updated": "Última atualização: Julho de 2026",
    "terms.intro": "Estes Termos de Uso regulam o acesso e a utilização da plataforma Ponto do Saber por seus usuários. Leia atentamente antes de criar sua conta.",
    "terms.consent": "Ao criar uma conta na plataforma Ponto do Saber, você declara ter lido, compreendido e concordado com estes Termos de Uso.",
  ...
  en: {
    ...
    "privacy.intro": "Ponto do Saber takes your privacy seriously. This policy describes how we collect, use, and protect your personal information in compliance with the Brazilian General Data Protection Law (LGPD - Law 13.709/2018).",
    "privacy.consent": "By creating an account on Ponto do Saber, you declare that you have read and agreed to this Privacy Policy.",
    "terms.title": "Terms of Service",
    "terms.updated": "Last updated: July 2026",
    "terms.intro": "These Terms of Service govern access to and use of Ponto do Saber by its users. Please read them carefully before creating your account.",
    "terms.consent": "By creating an account on Ponto do Saber, you declare that you have read, understood, and agreed to these Terms of Service.",
