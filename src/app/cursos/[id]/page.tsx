    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-zinc-950">
        <div className="text-center">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">Carregando curso...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-zinc-950">
        <div className="text-center">
          ...
          <p className="text-lg font-medium text-zinc-700 dark:text-zinc-300">Curso não encontrado</p>
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">O curso pode ter sido removido ou o link está incorreto.</p>
          <Link href="/cursos" className="mt-4 inline-flex items-center gap-2 rounded-lg bg-zinc-900 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-zinc-800 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-200">
