        ...
        {nextLesson ? (
          <div className="flex items-center justify-between gap-4 border-t border-zinc-800 px-5 py-4">
            <div className="min-w-0">
              <p className="text-[10px] font-semibold uppercase tracking-wider text-amber-400">Próxima aula</p>
              <p className="mt-0.5 truncate text-sm font-medium text-white">{nextLesson.title}</p>
            </div>
            <Link
          ...
          <div className="border-t border-zinc-800 px-5 py-4 text-sm font-medium text-green-400">
